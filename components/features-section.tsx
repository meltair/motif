...
export default function FeaturesSection() {
  ...
  return (
    <section className="relative px-4 py-12 sm:px-6 sm:py-16 lg:px-0">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mt-4 text-balance text-3xl font-semibold tracking-[-0.05em] text-slate-950 sm:mt-8 sm:text-5xl md:text-6xl">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-slate-600 sm:mt-5 sm:text-lg">
        ...
        <div className="mt-10 grid gap-5 sm:mt-14 sm:gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-slate-950 p-6 text-white shadow-[0_30px_90px_rgba(15,23,42,0.18)] sm:rounded-[36px] sm:p-8 lg:p-10">
            ...
            <div className="relative">
              <h3 className="mt-2 text-2xl font-semibold tracking-[-0.05em] sm:mt-4 sm:text-3xl lg:text-4xl">
                Styling at its best.
              </h3>

              <p className="mt-4 max-w-2xl text-sm leading-8 text-white/75 sm:mt-5 sm:text-base">
            ...
            {featureCards.map((card, index) => {
              ...
              return (
                <div
                  key={card.title}
                  className={[
                    "group relative overflow-hidden rounded-[24px] border bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.06)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_50px_rgba(15,23,42,0.10)] sm:rounded-[30px] sm:p-6",
                    card.tone,
                ...
                >
                  ...
                  <div className="relative">
                    <div className="flex items-start justify-between gap-4">
                      <div className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-current/10 bg-white/70 shadow-sm sm:h-12 sm:w-12">
                        <Icon className="h-5 w-5 sm:h-6 sm:w-6" />
                      </div>
                    </div>

                    <h4 className="mt-5 text-lg font-bold tracking-[-0.03em] text-slate-950 sm:mt-6 sm:text-xl">
                      {card.title}
                    </h4>
