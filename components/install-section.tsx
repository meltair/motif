    ...
    <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
      <div className="mx-auto mb-10 max-w-5xl text-center">
        <h2 className="mt-3 text-balance text-4xl font-semibold tracking-[-0.04em] text-slate-950 sm:text-5xl">
          Fast path from zero to usable UI.
        </h2>
        <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-slate-600">
          Show the installation story early and clearly. Developers should understand package setup in seconds, not spelunk through prose caves with a headlamp.
        </p>
      </div>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  Built on top of Next.js primarily to reduce boilerplate
                  during library development, component testing and docs work.
                </p>
              </div>
