...
export default function PitchSection() {
	return (
		<section className="border-t border-slate-200 bg-[linear-gradient(135deg,#172738_0%,#2b383b_40%,#24364a_100%)] text-white"> 
			<div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-2">
				<div>
					...
					<p className="mt-5 max-w-3xl text-lg leading-9 text-white-300">
					...
					<div className="mt-8 flex flex-wrap gap-3">
						...
						<Link
							...
							className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/90 px-5 py-3 text-sm font-bold text-gray-800 transition hover:bg-white/10">
					...
					<div className="mt-6 flex flex-wrap items-center gap-3">
						<Link
							...
							className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/10 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/10">
							<Github className="h-4 w-4" />
							GitHub
						</Link>
				...
				<div className="lg:pl-2">
					<div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
						<div className="flex items-start gap-4">
							<div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-white-500/30 bg-white-500/10 text-white-400">
